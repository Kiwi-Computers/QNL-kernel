...
#ifndef __CHARGER_TYZC25700_H_
#define __CHARGER_TYZC25700_H_

#define CHARGER_CURRENT_EVENT	0x01
#define INPUT_CURRENT_EVENT	0x02

struct tyzc2570x_platform_data {
...
void tyzc25700_charger_set_current(unsigned long event, int current_value);
